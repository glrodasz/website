...
export const contactSocials: SocialLink[] = [
  { id: 'twitter', label: 'Twitter / X', href: 'https://x.com/germorodas' },
  { id: 'instagram', label: 'Instagram', href: 'https://instagram.com/germorodas' },
  ...
  { id: 'threads', label: 'Threads', href: 'https://threads.net/@germorodas' },
];

/** Footer “Follow me” — order matches guillermorodas.com */
export const footerSocials: SocialLink[] = [
  { id: 'twitter', label: 'Twitter', href: 'https://x.com/germorodas' },
